...
SECONDsiA = \relative c'' {
  ...
  \bar ".|:" \force-clef-treble
    ...
    \bar ".|:" \scaleDurations 4/10 { 
      << { \n b1\shortfermata^\< \stemless e,4^\mf } \\ 
        { s1 \xNotesOn \stemless g'4 } >> } \bar ":|."
}
...
SECONDsiiA = \relative c'' {
  \SECONDtuttiA
  \tempo \markup \small {" dry, mechanically"}
...
SECONDbiiA = \relative c {
  ...
  \bar ".|:" \scaleDurations 2/5 { 
    << { \n c1\shortfermata^\< \stemless d4^\mf } \\ 
    { s1 \xNotesOn \stemless b'4 } >> } \bar ":|."
  \fat-line s2
}
...
SECONDsiB = \relative c'' {
  ...
  \force-clef-treble d,1*1/2^\p\longfermata
...
SECONDsiiB = \relative c'' {
  \SECONDtuttiB
  \override TextSpanner.bound-details.left.text = "dim. e rall."
...
SECONDbiiB = \relative c {
  ...
  \force-clef-bass e1*1/2^\p\longfermata
}
