...
FIRSTtiA = \relative c' {
  ...
  \bar ".|:" \force-clef-tenor e1^\pp\longfermata \breathe \bar ":|."
  \fat-line s1
  \fat-line { s2 s1 }
}
...
FIRSTtiiA = \relative c' {
  ...
  \bar ".|:" \force-clef-tenor cis1^\pp\longfermata \breathe \bar ":|."
  \fat-line { s2. | s1 }
...
FIRSTbiiA = \relative c {
  ...
  \bar ".|:" \force-clef-bass c1^\pp\longfermata \breathe \bar ":|."
  \fat-line s1
  \fat-line { s4 s1 }
}
